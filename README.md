...
- 🔢 **배열 인덱스 할당**: `arr[i] = value` 완벽 지원 (v2.3.1)
- 📝 **이스케이프 문자**: `\n`, `\t`, `\\`, `\"` 등 지원 (v2.3.1)
...
print("줄1\n줄2\n줄3")          # 개행
print("이름:\t홍길동")           # 탭
print("C:\\Users\\Documents")   # 백슬래시
print("\"안녕하세요\"")          # 따옴표
```

#### stdlib/math 모듈 개선 (50+ 함수)
```finelang
import math
...
# 간단해진 API (길이 파라미터 제거)
print(math.sum(arr))       # 27
print(math.mean(arr))      # 4.5
print(math.median(arr))    # 4
print(math.std_dev(arr))   # 2.81
...
├── CHANGELOG.md           # 변경 이력
└── VM_IMPLEMENTATION.md   # VM 구현 문서 (v2.3.0)
```
...
| 버전 | 날짜 | 주요 기능 |
|------|------|----------|
| **v2.3.0** | 2025-11-12 | ⚡ 바이트코드 VM + For 루프 |
| **v2.2.8** | 2025-11-10 | ✅ Boolean 타입 (true/false) |
| **v2.2.6** | 2025-11-10 | 🔧 유틸리티 함수 (contains, min, max 등) |
| **v2.2.5** | 2025-11-10 | 🔍 Null 타입 + 타입 체크 함수 |
| **v2.2.4** | 2025-11-09 | ➗ 나머지(%), 몫(//) 연산자 |
| **v2.2.3** | 2025-11-09 | 🏷️ 모듈 별칭 (import as) |
| **v2.2.2** | 2025-11-09 | 📦 from...import 구문 |
| **v2.2.1** | 2025-11-09 | 🎯 2차원 인덱싱 (m[i][j]) |
| **v2.2.0** | 2025-11-09 | ➕ 행렬 연산 (+, -, *, @) |
| **v2.1.0** | 2025-11-09 | 📊 행렬 타입 |
